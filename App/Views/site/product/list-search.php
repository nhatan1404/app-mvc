            ...
            <div class="row">
              <div class="col-lg-4 col-md-5">
                <div class="filter__sort">
                  ...
                  <form method="get" action="">
                    <input type="hidden" value="<?php echo $this->getQueryByKey('keyword') ?>" name="keyword" />
              ...
              <div class="col-lg-4 col-md-4">
                <div class="filter__found">
                  <h6 class='text-success'>Tìm thấy <?php echo $this->countProduct ?> sản phẩm cho từ khoá "<?php echo $this->getQueryByKey('keyword') ?>" </h6>
                </div>
              </div>
