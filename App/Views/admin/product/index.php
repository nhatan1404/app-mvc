<div class="container-fluid">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="<?php echo $this->helper->createUrl('admin/product/create') ?>" class="btn btn-success btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Tạo danh mục sản phẩm"><i class="fas fa-plus"></i> Tạo Mới</a>
    </div>
    <div class="card-body">
            ...
            <tbody>
              ...
              foreach ($this->products as $product) { ?>
                <tr>
                  ...
                  <td>
                    <img src="<?php echo $this->helper->createUrlImg($product->images) ?>" class="img-fluid zoom" style="max-width:80px" alt="<?php echo $product->title ?>">
                  </td>
                  ...
                  <td class='col-sm-1'>
                    ...
                    <form method="POST" action="<?php echo $this->helper->createUrl('admin/product/' . $product->id . '/delete') ?>">
